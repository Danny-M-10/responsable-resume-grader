...
- Be CONSISTENT: Similar candidates MUST receive similar component scores
- Be DETERMINISTIC: Re-evaluating the same candidate should produce the same scores
- Cross-reference: If candidate has all must-have certs, that component MUST be 8-10
- Cross-reference: If candidate missing critical requirements, overall score MUST reflect this
- Use evidence: Base scores ONLY on explicitly stated information in the resume
